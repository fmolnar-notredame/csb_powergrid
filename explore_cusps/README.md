...
It will open a GUI showing a heat map and level curves of stability (&lambda;<sup>max</sup>) on the plane M, as in Supplementary Fig. 2 of the paper. By simply moving the cursor, you will be able to see how lmax and the full eigenvalue spectrum of the Jacobian J changes as a function of the position on M.
